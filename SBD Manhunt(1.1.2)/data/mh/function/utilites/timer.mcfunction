...
# Display the timer
execute if score Mins Min matches 0 run title @a actionbar ["",{"text":"|  ","bold":true,"color":"green"},{"score":{"name":"Secs","objective":"Sec"},"bold":true,"color":"green"},{"text":"s","bold":true,"color":"yellow"},{"text":"  |","bold":true,"color":"green"}]
execute if score Mins Min matches 1.. run title @a actionbar ["",{"text":"|  ","bold":true,"color":"green"},{"score":{"name":"Mins","objective":"Min"},"bold":true,"color":"green"},{"text":"m","bold":true,"color":"yellow"},{"text":":","bold":true,"color":"green"},{"score":{"name":"Secs","objective":"Sec"},"bold":true,"color":"green"},{"text":"s","bold":true,"color":"yellow"},{"text":"  |","bold":true,"color":"green"}]
